...
const SkillsSlider = () => {
  return (
    <motion.div
      ...
      className="w-[70%] y-[100%] md:w-[33%] mt-16 md:p-0 p-3"
    >
      <Swiper
        breakpoints={{
          700: {
      ...
      >
        <SwiperSlide className="mb-10">
          <div className="grid md:grid-cols-3 grid-cols-2 gap-y-4 md:gap-x-4 gap-x-2">
        ...
        <SwiperSlide className="mb-10">
          <div className="grid md:grid-cols-3 grid-cols-2 gap-y-3">
